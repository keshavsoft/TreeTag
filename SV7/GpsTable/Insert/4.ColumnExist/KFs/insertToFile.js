...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {DateTime : LocalCoumnDateTime,TreeName : LocalCoumnTreeName,Latitude : LocalCoumnLatitude,Longitude : LocalCoumnLongitude,UserName : LocalCoumnUserName,pk : LocalCoumnpk};
