...
const StartFunc = ({LocalCoumnDateTime,LocalCoumnTreeName,LocalCoumnLatitude,LocalCoumnLongitude}) => {
  const LocalFileName = ParamsJson.TableName;
  const LocalDataPath = ParamsJson.DataPath;

  let LocalinDataToInsert = {DateTime : LocalCoumnDateTime,TreeName : LocalCoumnTreeName,Latitude : LocalCoumnLatitude,Longitude : LocalCoumnLongitude};
