...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {username : LocalCoumnusername,password : LocalCoumnpassword,name : LocalCoumnname,date : LocalCoumndate,plantNo : LocalCoumnplantNo,lat : LocalCoumnlat,lng : LocalCoumnlng};
